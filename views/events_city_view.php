...
<html lang="<?= htmlspecialchars($lang) ?>">
    ...
    <section>
      <h2 class="mb-3"><?= __t('all-events-in') ?> (<?= htmlspecialchars($userCity) ?>)</h2>

      <!-- Filtry -->
      <form method="get" action="<?= app_url('page/your-city-events') ?>" class="row g-3 mb-4">
        <div class="col-md-4">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-4 g-4">
        ...
        <div class="col">
          <div class="card h-100">
            <img src="<?= coverImage($event['event_type_id']) ?>"
                 class="card-img-top"
            ...
            <div class="card-footer text-center">
                <a href="<?= app_url('page/viewEvent/' . urlencode((string)$event['id'])) ?>"
